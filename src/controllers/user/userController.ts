...
class UserController extends BaseController {
   ...
   */
  public getUsersByIdsWithReport = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    await this.handleRequest(
      req,
      res,
      next,
   ...
   */
  public getAuthorizedReportersWithUsersAndReports = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    await this.handleRequest(
      req,
      res,
      next,
   ...
   */
  public getAuthorizedReportersWithOneWeekReports = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    await this.handleRequest(
      req,
      res,
      next,
    ...
    await this.handleRequest(
      ...
      async () => {
        validateInput(req.body, [
          ...
          { field: 'projectId', required: true, type: 'number' },
   ...
   */
  public getUsersExceptId = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    await this.handleRequest(
      req,
      res,
      next,
...
export const getAuthorizedReportersWithUsersAndReports = userController.getAuthorizedReportersWithUsersAndReports;
export const getAuthorizedReportersWithOneWeekReports = userController.getAuthorizedReportersWithOneWeekReports;
